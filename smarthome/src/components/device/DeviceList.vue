<template>
  <div>
    ...
    <hr>
    <div>
      <p v-if="!devices.length&&$route.path === '/device-list'"><strong>还没有任何设备</strong></p>
      <div class="list-group">
        <router-view></router-view>
      </div>
      <div v-if="$route.path === '/device-list'" class="list-group">
        <!--
...
//    },
    ...
    mounted() {
      const vm = this;
      vm.$nextTick(() => {
        vm.$store.dispatch('showDevice', 999);
      });
    },
//    watch: {
