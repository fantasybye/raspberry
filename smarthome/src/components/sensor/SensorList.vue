<template>
  <div>
    <div v-if="$route.path === '/show-devices/show-sensors/edit-sensor'">
      <h3>编辑该传感器</h3>
    </div>
    <hr>
    <!--<router-view></router-view>-->
    <div class="show-sensors">
      <p v-if="!sensors.length&&$route.path === '/sensor-list'"><strong>还没有任何传感器</strong></p>
      <div class="list-group">
        <router-view></router-view>
      </div>
      <div v-if=" $route.path === '/sensor-list'"class="list-group">
        <!--
